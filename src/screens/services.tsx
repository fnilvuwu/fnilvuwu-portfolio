...
export const tags: Tag[] = [
    ...
    { name: 'TensorFlow', type: 'tech', imageUrl: '/images/my_tech_stacks/tensorflow-logo.webp' },
    ...
    { name: 'Flask', type: 'tech', imageUrl: '/images/my_tech_stacks/flask-logo.webp' },
    ...
    { name: 'React', type: 'tech', imageUrl: '/images/my_tech_stacks/react-logo.webp' },
    { name: 'Firebase', type: 'tech', imageUrl: '/images/my_tech_stacks/firebase-logo.webp' },
    { name: 'MySQL', type: 'tech', imageUrl: '/images/my_tech_stacks/mysql-logo.svg' },
    { name: 'Streamlit', type: 'tech', imageUrl: '/images/my_tech_stacks/streamlit-logo.webp' },
    ...
    { name: 'Docker', type: 'tech', imageUrl: '/images/my_tech_stacks/docker-logo.webp' },
    ...
    { name: 'Dart', type: 'tech', imageUrl: '/images/my_tech_stacks/dart-logo.webp' },
    { name: 'Android Studio', type: 'tech', imageUrl: '/images/my_tech_stacks/android_studio-logo.svg' },
    { name: 'Kotlin', type: 'tech', imageUrl: '/images/my_tech_stacks/kotlin-logo.webp' },
    { name: 'Java', type: 'tech', imageUrl: '/images/my_tech_stacks/java-logo.svg' },
    { name: 'JavaScript', type: 'tech', imageUrl: '/images/my_tech_stacks/javascript-logo.webp' },
    ...
    { name: 'VBA', type: 'tech', imageUrl: '/images/my_tech_stacks/vba-logo.webp' },
    { name: 'Linux', type: 'tech', imageUrl: '/images/my_tech_stacks/linux-logo.webp' },
    { name: 'YOLO', type: 'tech', imageUrl: '/images/my_tech_stacks/yolo-logo.webp' },
    ...
    { name: 'Tableau', type: 'tech', imageUrl: '/images/my_tech_stacks/tableau-logo.webp' },
    ...
    { name: 'Plotly', type: 'tech', imageUrl: '/images/my_tech_stacks/plotly-logo.webp' },
    { name: 'WordPress', type: 'tech', imageUrl: '/images/my_tech_stacks/wordpress-logo.webp' },
